...
public class RagController {
    ...
    private Logger logger = LoggerFactory.getLogger(RagController.class);

    private final CompiledGraph compiledGraph;

    public RagController(@Qualifier("ragGraph")StateGraph ragGraph) throws GraphStateException {
        this.compiledGraph = ragGraph.compile();
    }

    @GetMapping("/rag")
    public Flux<ServerSentEvent<String>> rag(@RequestParam("query") String query) {
