...
export declare const MARKSTREAM_RENDERER_CONTEXT: unique symbol;
export declare function provideMarkstreamRendererContext(ctx: MarkstreamRendererContext): void;
export declare function useMarkstreamRendererContext(): MarkstreamRendererContext;
